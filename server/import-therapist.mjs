...
async function importTherapist(profile) {
  ...
  var document = {
    ...
    availabilityPosture: profile.availabilityPosture || "",
    waitlistWeeks: profile.waitlistWeeks || null,
    prescribingMode: profile.prescribingMode || "",
    crisisPosture: profile.crisisPosture || "",
